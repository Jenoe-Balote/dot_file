...
then
    ...
    cd ../..
    echo "[![GitHub's SuperLinter](https://github.com/Jenoe-Balote/$1/workflows/GitHub's%20Super%20Linter/badge.svg)](https://github.com/Jenoe-Balote/$1/actions)" >> ./README.md
else
    # Adds the linter yml file to ./github/workflows and then adds the linter
    # badges to the README
    cp ~/scripts/swift.yml ./main.yml
    cd ../..
    echo "[![SwiftLint](https://github.com/Jenoe-Balote/$1/workflows/SwiftLint/badge.svg)](https://github.com/Jenoe-Balote/$1/actions)" >> ./README.md
fi
